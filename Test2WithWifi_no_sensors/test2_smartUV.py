...
"""
# Note:
#   This program is modified from Test1. I used the disabled sensor modules here and arbitrarily set onTime=10s on line 184
#   This should be able to run on the pi zero and interact with the pi4/wifi, although not tested.
...
## Used disabled sensor modules here
...
class sim_smartUV:
    ...
    def state_INITIAL(self):
        ...
        self.onTime=10 #Instead of getting from sensors, place onTime=10s here
